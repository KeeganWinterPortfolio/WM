import MainImageWMBeast from "../../public/images/MainImageWMBeast.png";
import MainImageWMBeastLarge from "../../public/images/MainImageWMBeastLarge.png";
import MainImageWMBeastMedium from "../../public/images/MainImageWMBeastMedium.png";
    ...
    <div className="flex flex-col items-center space-y-6 z-10">
      ...
      <div className="w-full hidden justify-end xl:flex">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMBeastLarge} alt="" className="" />
      ...
      <div className="w-full hidden justify-end lg:flex xl:hidden">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMBeastMedium} alt="" className="" />
          {/* Left Border Black Gradient */}
      ...
      <div className="w-full flex justify-end lg:hidden">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMBeast} alt="" className="mt-6" />
          {/* Left Border Black Gradient */}
          <div className="w-full h-full absolute  top-0 bg-black opacity-60"></div>
          {/* Left Border Black Gradient */}

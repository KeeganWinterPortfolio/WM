import MainImageWMDragon from "../../public/images/MainImageWMDragon.png";
import MainImageWMDragonLarge from "../../public/images/MainImageWMDragonLarge.png";
import MainImageWMDragonMedium from "../../public/images/MainImageWMDragonMedium.png";
    ...
    <div className="flex flex-col items-center space-y-6 z-10">
      ...
      <div className="w-full hidden justify-end xl:flex">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMDragonLarge} alt="" className="" />
      ...
      <div className="w-full hidden justify-end lg:flex xl:hidden">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMDragonMedium} alt="" className="" />
          {/* Left Border Black Gradient */}
      ...
      <div className="w-full flex justify-end lg:hidden">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMDragon} alt="" className="mt-6" />
          {/* Left Border Black Gradient */}

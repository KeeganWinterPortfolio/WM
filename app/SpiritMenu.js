...
import ExtendedMenuBanshee from "../public/images/ExtendedMenuBanshee.png";
import ExtendedMenuAngelOfDeath from "../public/images/ExtendedMenuAngelOfDeath.png";
...
const posts = [
  {
    id: 1,
    title: "Angelystor",
    href: "/Spirit/Angelystor",
    description:
      "Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel iusto corrupti dicta laboris incididunt.",
    imageUrl: ExtendedMenuAngelOfDeath,
    date: "June 24, 2023",
    datetime: "2023-06-24",
    category: { title: "Spirit", href: "/Spirit/Angelystor" },
    author: {
      name: "Keegan",
      role: "Article Author",
      href: "/Spirit/Angelystor",
  ...
  },
  {
    id: 2,
    title: "Cyhraeth",
    href: "/Spirit/Cyhraeth",
    description:
      "Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel iusto corrupti dicta laboris incididunt.",
    imageUrl: ExtendedMenuBanshee,
    date: "June 24, 2023",
    datetime: "2023-06-24",
    category: { title: "Spirits", href: "/Spirit/Cyhraeth" },
    author: {
      name: "Keegan",
      role: "Article Author",
      href: "/Spirit/Cyhraeth",
...
export default function SpiritMenu() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <p className="mt-2 text-lg leading-8 text-neutral-300">
            Learn about the rich history of spirits in welsh myth.
          </p>
          <Link href="/Fairies">

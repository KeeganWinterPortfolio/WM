import MainImageWMSpirit from "../../public/images/MainImageWMSpirit.png";
import MainImageWMLargeSpirit from "../../public/images/MainImageWMLargeSpirit.png";
import MainImageWMMediumSpirit from "../../public/images/MainImageWMMediumSpirit.png";
    ...
    <div className="flex flex-col items-center space-y-6 z-10">
      ...
      <div className="w-full hidden justify-end xl:flex">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMLargeSpirit} alt="" className="" />
      ...
      <div className="w-full hidden justify-end lg:flex xl:hidden">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMMediumSpirit} alt="" className="" />
          {/* Left Border Black Gradient */}
      ...
      <div className="w-full flex justify-end lg:hidden">
        <div className="w-auto relative">
          {/* Image */}
          <Image src={MainImageWMSpirit} alt="" className="mt-6" />
          {/* Left Border Black Gradient */}
          <div className="w-full h-full absolute  top-0 bg-black opacity-60"></div>
          {/* Left Border Black Gradient */}
